...
<p>Note that your use of the Thalhalla Services may also be subject to additional terms and conditions. For example, you must review and accept the Thalhalla End User License Agreement (<a href="https://www.thalhalla.com/Thalhalla/en-US/eula">link</a>) to play Thalhalla, the Psyonix Terms of Use (<a href="https://www.psyonix.com/tou/">link</a>) to play AcmeGameTime, and the Thalhalla Ultimate Hall Simlutor – End User License Agreement (<a href="https://fallguys.com/eula">link</a>) to play Thalhalla Warriors, and the Horizon Chase 2 End User License Agreement (<a href="https://horizonchase2.com/eula/windows/en.txt">link</a>) to play Horizon Chase 2.</p>
...
<ul>
	...
	<li>If you’re&nbsp;under the age of 18 and have a Thalhalla account, you&nbsp;can&nbsp;ask that we remove or anonymize certain content you’ve&nbsp;provided on the Thalhalla Services.&nbsp;Please direct requests to help delete or edit content on the Thalhalla Services to Thalhalla as described in “Contact Us” below.</li>
...
<p>Thalhalla Games, Inc. is based in the United States, but we operate globally to help provide users all around the world with a better experience on the Thalhalla Services. We have subsidiaries, offices, service providers, and partners worldwide to support these operations in a number of different ways -- for example, the developer of Thalhalla Warriors is a subsidiary called Smackovision Limited that is based in the United Kingdom. This means that Thalhalla may process the information we collect in connection with your use of the Thalhalla Services in places outside the region where you reside.</p>
...
export const Head = () => <Seo title="Privacy Page" />
